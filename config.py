...
# Embeddings
OPENAI_EMBEDDING_MODEL = "text-embedding-3-small"  # Модель OpenAI для embeddings
EMBEDDING_DIMENSION = 1536  # Размерность вектора модели
...
# Лимиты
MAX_CONTEXT_LENGTH = 12000  # Максимальная длина контекста для промпта (символов)
MAX_SEARCH_RESULTS = 3  # Количество результатов поиска в Qdrant
MAX_TOKENS_RESPONSE = 2000  # Максимальное количество токенов в ответе GPT
