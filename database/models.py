from sqlalchemy import (
    ...
    Text, Enum as SQLEnum, ForeignKey, TIMESTAMP, func
)
...
class Dialog(Base):
    ...
    messages = relationship("Message", back_populates="dialog", cascade="all, delete-orphan", order_by="Message.sent_at")
...
class Message(Base):
    ...
    dialog_id = Column(BigInteger, ForeignKey("dialogs.dialog_id", ondelete="CASCADE"), nullable=False, index=True)
    user_id = Column(BigInteger, ForeignKey("users.user_id", ondelete="CASCADE"), nullable=False, index=True)
